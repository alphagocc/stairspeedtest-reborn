...
if [[ "$MSYSTEM" = "MINGW64" ]];then
    curl -LO https://github.com/v2fly/v2ray-core/releases/v4.45.2/download/v2ray-windows-64.zip
...
if [[ "$MSYSTEM" = "MINGW32" ]];then
    curl -LO https://github.com/v2fly/v2ray-core/releases/v4.45.2/download/v2ray-windows-32.zip
